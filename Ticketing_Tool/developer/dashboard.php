                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="py-4 m-0 text-center h1 text-success">
                                ...
                                $req = mysqli_query($con, "select count(*) as c from request where assign_name='".$_SESSION['user']."'");
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="py-4 m-0 text-center h1 text-info">
                                 <?php
                                include "../connection.php";
                                $req1 = mysqli_query($con, "select count(*) as c from incident where assign_person='".$_SESSION['user']."'");
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="mt-4 text-center">
                                ...
                                $rate1 = 0;
                                include "../connection.php";
                                $req = mysqli_query($con, "select count(*) as c from request where assign_name='".$_SESSION['user']."' and state != 'close' ");
                                $res = mysqli_fetch_array($req);
                                $rate += $res['c'];
                                
                                $req1 = mysqli_query($con, "select count(*) as r from incident where assign_person='".$_SESSION['user']."' ");
                                $res1 = mysqli_fetch_array($req1);
                                $rate += $res1['r'];
                                
                                $req2 = mysqli_query($con, "select count(*) as c from request where assign_name='".$_SESSION['user']."' ");
                                $res2 = mysqli_fetch_array($req2);
                                $rate1 += $res2['c'];
                                
                                $req3 = mysqli_query($con, "select count(*) as r from incident where assign_person='".$_SESSION['user']."' and state = 'close' ");
